# Dummy module to allow using 'install Symphero::Web' in CPAN shell.
# Let me know if there is better way to achieve that <am@xao.com>.
#####################################################################
package Symphero::Web;
1;
__END__
...
processed by symphero.pl. Here is an example:
...
That leaves everything in /images/ to be processed by web server in a
...
Symphero::Objects::mysite::Config, where mysite is your site name.
...
do that as most of Symphero modules require database connection to work
properly.
...
Brave New Worlds, Andrew Maltsev <am@xao.com>. Creating of Symphero::Web
...
Recommended reading:
L<symphero.pl>,
L<Symphero::Categories>,
L<Symphero::Objects>,
L<Symphero::OrdersDB>,
L<Symphero::ProductsDB>,
